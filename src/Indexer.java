...
public final class Indexer 
{
	...
	public static void main(String [] args) 
	{
	    ...
	    try 
	    {
	    	...
	    	Object obj = parser.parse(new FileReader("C:/Users/Benjamin/Documents/Development/data/html_files.json"));
			...
			for(Integer i = 0; i < FILE_COUNT;  i++)
			{
				...
				page = (JSONObject)jsonObject.get(i.toString());
				...
				File input = new File("C:/Users/Benjamin/Documents/Development/data/Html/" + key);
		    ...
		    for(Integer term : term2termid.values()) 
		    {
		    	...
		    	{
		    		wtf = (float) (1 + Math.log10(termid2tflist.get(term).get(doc)));
